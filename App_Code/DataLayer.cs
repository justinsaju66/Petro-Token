...
public class DataLayer
{
    ...
    public string GetConnectionString()
    {
        ...
        string strConnectionString = "Data Source=localhost;initial catalog=petro_token1;Uid=root;Password=root";
    ...
    public DataSet GetDataSet(string qstr)
    {
        ...
        {
            DS = new DataSet();
            myAdapter = new MySqlDataAdapter(qstr, GetConnectionString());
            myAdapter.Fill(DS);
            myAdapter.Dispose();
            myAdapter = null;
            return DS;
